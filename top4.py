...
accident_top4 = sorted(accident_year().values())
...
def accident_count_year(accident_choice):
    accident_count = {}
    year_b = year_all[0]
    count = 0
    accidents = df.accident
...
def grah_line():
    ...
    for i in accident_top4_list:
        accident_add = accident_count_year(i)
        list_accident_count = [accident_add[year] for year in year_all]
        line_chart.add(i, list_accident_count)
